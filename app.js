...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderLecturers() {
    ...
    const list = displayLecturers.slice(start, end);
  ...
  function attachCardEvents() {
    document.querySelectorAll(".card").forEach(card => {
      ...
      card.querySelector(".card-name a").onclick = e => {
        e.stopPropagation();
        openLecturer(key);
      };
    });
  ...
  function renderPagination() {
    ...
    const totalPages = Math.ceil(displayLecturers.length / itemsPerPage);
  ...
  function openLecturer(key) {
    ...
    const fillList = (id, arr) => {
      ...
      el.innerHTML = "";
      if (arr) arr.forEach(i => el.innerHTML += `<li>${i}</li>`);
    };
    ...
    document.getElementById("modalInfoExtra").innerHTML = `
